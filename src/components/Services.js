...
const Services = () => {
  return (
    <CardGroup className="group-card g-3">
      <Card>
        <Card.Img variant="top" src={react1} />
        <Card.Body>
          <Card.Title>Desarrollo web SPA</Card.Title>
          <Card.Text>
            Todas las pantallas se muestran en un misma página, sin recargar el
            navegador, que aportan una agradable experiencia de usuario.
          </Card.Text>
        </Card.Body>
      </Card>
      ...
      <Card>
        ...
        <Card.Body>
          ...
          <Card.Text>
            ...
            personalizado con certificado SSL incluido Esto te protegerá de las
